...
IMAGE_PATH="./images/IMG_1331.jpg"
...
def square_detection(image, physical, resize_width=400):
    ...
    resize_width (int) -- The width to resize the image to. Default is 400.
    ...
    resized_image = resize_image(output_image, resize_width)
